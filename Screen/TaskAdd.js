...
const TaskAdd = ({navigation,props }) => {
...
console.log(formBody);
      ...
      fetch('https://olyextech.co.in/task/apiphp/insert.php', {
      method: 'POST',
      body: formBody,
      headers: {
        //Header Defination
...
const  getNextDate = () => {
  ...
  return (
    <View style={{flex: 1, backgroundColor: '#DFF1F7'}}>
      ...
      <Appbar.Content title="Task Add" subtitle="" />
      <Appbar.Action icon="content-save" size={35}  onPress ={() => {handleSubmitButtonsave()}} ></Appbar.Action>
    </Appbar.Header>
      <ScrollView
